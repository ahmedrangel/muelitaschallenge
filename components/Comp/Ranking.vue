...
// Establecer la fecha inicial en tu zona horaria local
...
<template>
  <div class="overflow-auto">
    <table class="table table-striped table-borderless overflow-hidden rounded mb-1">
      ...
      <tbody class="border">
        <tr v-for="p of participants" :key="p.raw_position" class="text-center align-middle" :style="`${p.is_banned ? 'filter: saturate(0) contrast(1.2); pointer-events: none' : ''}`">
          ...
          <td class="text-start">
            ...
            <div v-else class="d-flex align-items-center gap-2">
              <img class="rounded-circle img-profile" :src="`https://raw.communitydragon.org/14.4/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/${p.lol_picture}.jpg`">
